...
<div class="istat-comuni-form col-xs-12 nop">
    ...
    <div class="col-lg-6 col-sm-6">
        ...
        $form->field($model, 'istat_unione_dei_comuni_id')->dropDownList(
            \yii\helpers\ArrayHelper::map(open20\amos\comuni\models\IstatUnioneDeiComuni::find()->orderBy('nome')->all(), 'id', 'nome'),
            ['prompt' => 'Select']
        ); ?>
    </div>
    ...
    <div class="col-lg-6 col-sm-6">
        ...
        $form->field($model, 'istat_regioni_id')->dropDownList(
            \yii\helpers\ArrayHelper::map(open20\amos\comuni\models\IstatRegioni::find()->orderBy('nome')->all(), 'id', 'nome'),
            ['prompt' => 'Select']
        ); ?>
    </div>
    ...
    <div class="col-lg-6 col-sm-6">
        ...
        $form->field($model, 'istat_province_id')->dropDownList(
            \yii\helpers\ArrayHelper::map(open20\amos\comuni\models\IstatProvince::find()->orderBy('nome')->all(), 'id', 'nome'),
            ['prompt' => 'Select']
        ); ?>
    </div>
