...
class ImportatoreController extends Controller {
    ...
    public function actionImportCodiciCatastali() {
        ...
        if (!empty($this->arr_new) && !empty(\Yii::$app->request->post('confirm'))) {
            ...
            $flash_type = ($this->result_generate === true) ? 'success' : 'danger'
            ;
     ...
     */
    protected function generateMigrationFile($nome_migration, $type_migration_skel, $table_name, $new_data, $restore_data) {
